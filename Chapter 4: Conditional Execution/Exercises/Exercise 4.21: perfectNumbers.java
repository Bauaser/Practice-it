...
//The first two perfect numbers are 6 and 28, since 1+2+3=6 and 1+2+4+7+14=28. Write a static method perfectNumbers that takes an integer max 
//as an argument and prints out all perfect numbers that are less than or equal to max.
