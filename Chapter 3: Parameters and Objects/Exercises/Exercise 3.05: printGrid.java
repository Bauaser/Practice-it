...
//The output is a comma-separated grid of numbers where the first parameter (rows) represents the number of rows of the grid and the second 
//parameter (cols) represents the number of columns. 
//The numbers count up from 1 to (rows x cols).
//The output are displayed in column-major order, meaning that the numbers shown increase sequentially down each column and wrap to the top 
//of the next column to the right once the bottom of the current column is reached. 
