//Finish the given program called Stairs that uses the DrawingPanel to draw the figure shown below. 
...
//(If you're having trouble matching the output, make a table with the (x, y) coordinates and (width x height) sizes of the first five stairs. 
