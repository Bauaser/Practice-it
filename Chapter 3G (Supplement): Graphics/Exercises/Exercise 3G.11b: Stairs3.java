//Modify your Stairs program from the previous exercise to make a new class Stairs3 that draws the output shown below. 
...
public class Stairs3 {
    public static void main(String[] args) {
        ...
        for (int i = 10; i > 0; i--) {
            g.drawRect(i*10-5, 105-i*10, 110-i*10, 10);
        }
    }
}
