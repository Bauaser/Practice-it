//Suppose you have the following existing program called Face that uses the DrawingPanel to draw a face figure. 
//Modify the program to draw the graphical output shown below. Do so by writing a parameterized static method that draws a face at different positions. 
//The window size should be changed to 320 x 180 pixels, and the two faces' top-left corners are at (10, 30) and (150, 50). 
