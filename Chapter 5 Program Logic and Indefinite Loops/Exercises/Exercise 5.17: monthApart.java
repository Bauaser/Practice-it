...
//The following dates are NOT at least a month apart from 9/19: 9/20, 9/28, 10/1, 10/15, and 10/18. Note that the first date could come before or after (or be the same as) the second date. 
...
public boolean monthApart(int month1, int day1, int month2, int day2) {
    if(month1 == month2)
        return false;
